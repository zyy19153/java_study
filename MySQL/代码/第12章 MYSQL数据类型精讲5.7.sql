...
f1 INT,
f2 INT(5),
f3 INT(5) ZEROFILL # 1.显示宽度为5，当INSERT的值不足5位时，使用0填充。 2.当使用ZEROFILL时，会自动添加UNSIGNED。
);
...
VALUES(24124124),(1231231231231231);
...
VALUES(123.45,123.456); # 小数位超出所要求范围，就会自动四舍五入

INSERT INTO test_double1(f3,f4)
VALUES(123.45,1233.456); # Out of range value for column 'f4' at row 1

INSERT INTO test_double1(f3,f4)
VALUES(123.45,999.995); # Out of range value for column 'f4'
...
VALUES('男','睡觉,打豆豆'); # 注意，这里的逗号是英文的逗号
